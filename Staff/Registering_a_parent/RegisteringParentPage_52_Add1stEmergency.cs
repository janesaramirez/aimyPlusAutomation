...
namespace AimyTest.Registering_a_parent
{
    public class RegisteringParentPage_52_Add1stEmergency: MyElelment
    {
                            ...
                            , string WorkPhone)
        {
            ...
            if (Verify_ParentName(driver, script, "Name : " + FirstName.Trim()) && (Verify_ParentName(driver, script, LastName.Trim())))
            {
                log.Info("[PASS] CRE_PARENT_03 Registering new emergency contacts");
                Utilities.Common.TakeScreenShot(driver, "CRE_PARENT_03 Registering new emergency contacts");

            }
            else // wrong text display
            {
                log.Error("[FAIL] CRE_PARENT_03 Registering new emergency contacts-wrong text displayed");
                Utilities.Common.TakeScreenShot(driver, "FAIL- CRE_PARENT_03 Registering new emergency contacts");
                            ...
                            , string WorkPhone)
        {
            ...
            try
            {
                ...
                Utilities.Common.TakeScreenShot(driver, "1_EmergencyContact");
            ...
            catch (Exception e)
            {
                ...
                Utilities.Common.TakeScreenShot(driver, "1_EmergencyContact FAIL");
